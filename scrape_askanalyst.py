...
#  CONFIG
# ═══════════════════════════════════════════════════════════════════════
# Batch 14: Next 20 PSX companies (259 already scraped in Batches 1-13)
TICKERS = [
    "NONS", "NRSL", "OBOY", "OCTOPUS", "OLPL",
    "OTSU", "PABC", "PACE", "PAKD", "PAKOXY",
    "PAKRI", "PCAL", "PECO", "PGLC", "PHDL",
    "PIAHCLA", "PIBTL", "PICT", "PIL", "PINL",
]
